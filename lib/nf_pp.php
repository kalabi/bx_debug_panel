...
class nf_pp
{
    ...
    function __construct()
    {
        ...
        if (isset($options['showUnauthorized'])) {
            $this->showUnauthorized = $options['showUnauthorized'];
        }
        ...
        foreach ($options as $opt) {
            ...
            switch (gettype($opt)) {
                ...
                case 'boolean':
                    ...
                    $newOptions['showUnauthorized'] = $opt;
                    break;
...
if (!function_exists('isAdminPP')) {
    /**
     * проверка пользователя для вывода отладки
     * @return bool
     */
    function isAdminPP()
    {
...
/**
 * @desc подробная распечатка объектов
 *
 * @param array $array
 * @param bool  $die
 * @param bool  $show
